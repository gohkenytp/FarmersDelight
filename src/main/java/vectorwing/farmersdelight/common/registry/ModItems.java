...
public class ModItems
{
	...
	public static final RegistryObject<Item> TOMATO_SEEDS = ITEMS.register("tomato_seeds", () -> new ItemNameBlockItem(ModBlocks.BUDDING_TOMATO_CROP.get(), new Item.Properties().tab(FarmersDelight.CREATIVE_TAB)));
